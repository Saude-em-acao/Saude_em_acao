...
export const INFORME_ITEMS: InformeItem[] = [
  ...
  },
  {
    ...
    "conteudoCompleto": {
      "temaPrincipal": "Presença de resíduos de defensivos agrícolas e compostos lipofílicos em produtos ultraprocessados de origem animal e impactos climáticos.",
